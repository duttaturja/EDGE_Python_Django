...
from books.views import (
    ...
    APIBook ,APIAuthor, APIPublisher, BooklListAPIView,
      BookGetUpdateDelete)                     
...
urlpatterns = [
    ...
    path('api_list/', BooklListAPIView.as_view()),
    ...
    path('publishers_rest/', APIPublisher.as_view(), name='publisher_list_create'),
]